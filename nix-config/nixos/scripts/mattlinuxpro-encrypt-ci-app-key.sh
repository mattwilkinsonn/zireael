#!/usr/bin/env bash
# One-time bootstrap on mattlinuxpro: encrypt the sealedsecurity-ci
...
#
# Usage:
#   sudo bash nixos/scripts/mattlinuxpro-encrypt-ci-app-key.sh /path/to/sealedsecurity-ci.pem
...
# stages both the agent token and this key — see the shared
